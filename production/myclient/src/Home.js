...
class Home extends React.Component{
  ...
  componentDidMount(){
    ...
    if(!this.state.checked){
      url = 'http://ec2-54-89-99-60.compute-1.amazonaws.com:4000/api/homeNY';
    }
    else{
      url = 'http://ec2-54-89-99-60.compute-1.amazonaws.com:4000/api/homeGuardian';
    }
    fetch(url, {mode: 'cors'}).then(
      ...
      (res) => {
        let data = [];
        if(url === 'http://ec2-54-89-99-60.compute-1.amazonaws.com:4000/api/homeNY'){
          data = res.results;
        }
        else{
    ...
    return (
      ...
      <Navbar collapseOnSelect expand="lg" bg="dark" variant="dark">
        ...
        <Nav className="mr-auto">
          <Nav.Link as={NavLink} to="/" href="/" activeClassName='active'>Home</Nav.Link>
